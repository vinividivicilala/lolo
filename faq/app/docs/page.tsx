...
export default function DocsPage() {
  ...
  const [updateText, setUpdateText] = useState("NEW");
  ...
  // Animasi update text
  const updateTexts = ["NEW", "UPDATE", "FEATURES", "LATEST"];
  ...
  useEffect(() => {
    ...
    const updateInterval = setInterval(() => {
      updateIndex = (updateIndex + 1) % updateTexts.length;
      setUpdateText(updateTexts[updateIndex]);
    }, 2000);
  ...
  return (
    <div style={{
      ...
      {/* Top Navigation Bar - DIPERBAIKI: Tanpa Home button */}
      <div 
        ref={topNavRef}
        style={{
          position: 'fixed',
      ...
      >
        <div style={{
          ...
          {/* Docs - DIPERBAIKI: Dengan animasi update text */}
          <motion.div
          ...
          >
            ...
            <div style={{
              backgroundColor: '#10B981', // Hijau cerah untuk animasi
              color: 'white',
              fontSize: '0.7rem',
              fontWeight: '700',
      ...
      {/* Header Section dengan HOME / DOCS dan Judul Website */}
      <div 
        ref={headerRef}
        style={{
          position: 'fixed',
      ...
      >
        ...
        >
          ...
          <motion.span
            onClick={() => router.push('/')}
            onMouseEnter={() => handleLinkHover("link", "HOME", "home-breadcrumb")}
            onMouseLeave={handleLinkLeave}
            style={{
              color: isDarkMode ? 'white' : 'black',
            ...
            whileHover={{ 
              opacity: 1,
              color: isDarkMode ? '#CCFF00' : '#CCFF00'
            }}
          >
            HOME
          </motion.span>
      ...
      {/* Card Design - TETAP SAMA PERSIS seperti halaman utama */}
      <motion.div
        ref={cardRef}
        style={{
        ...
        whileTap={{ scale: 0.98 }}
      >
        {/* Content Section - TETAP SAMA PERSIS */}
        <div style={{
          display: 'flex',
          width: '100%',
          gap: isMobile ? '1.5rem' : '3rem',
          ...
          {/* Left Section - MENURU - TETAP SAMA PERSIS */}
          <div style={{
            flex: 1,
            display: 'flex',
            flexDirection: 'column',
            ...
            {/* Daftar Website Pribadi Section - Responsive - TETAP SAMA PERSIS */}
            <motion.div
              style={{
                width: '100%',
          ...
          {/* Right Section - LETS COLLABORATE - TETAP SAMA PERSIS */}
          <div style={{
            flex: isMobile ? 1 : 0.6,
            display: 'flex',
            flexDirection: 'column',
