// app/donatur/page.tsx (Halaman Donatur) - VERSI TANPA SCROLLSMOOTHER
'use client';
...
export default function DonaturPage(): React.JSX.Element {
  ...
  return (
    <>
      ...
      {/* Main Content - Tanpa ScrollSmoother wrapper */}
      <div style={{
        minHeight: '100vh',
        backgroundColor: 'white',
        margin: 0,
        ...
        {/* Footer - di paling akhir dengan margin top besar agar terlihat */}
        <footer style={{
          position: 'relative',
          width: '100%',
          display: 'flex',
