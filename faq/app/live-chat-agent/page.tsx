...
// Footer links - tanpa Live Chat Agent
const footerLinks = [
...
// ===== LIVE CHAT AGENT COMPONENT (sama seperti di halaman utama) =====
interface Ticket {
  id: string;
  userId: string;
  userName: string;
...
export default function LiveChatPage(): React.JSX.Element {
  ...
  return (
    <>
      ...
      >
        {/* HERO SECTION - sama seperti halaman utama */}
        <div
          style={{
            minHeight: "60vh",
            display: "flex",
        ...
        {/* FOOTER - sama seperti halaman utama, tanpa Live Chat Agent */}
        <div
          style={{
            width: "100%",
