...
export default function HomePage(): React.JSX.Element {
  ...
  return (
    <>
      ...
      >
        {/* HERO SECTION - konten di bawah judul web, tanpa scroll besar */}
        <div
          ref={heroRef}
          style={{
            minHeight: "100vh",
        ...
        {/* NAVBAR - FIXED di atas dengan Anti Fraud font 50px */}
        <div
          ref={navbarRef}
          style={{
            position: "fixed",
        ...
        >
          {/* Anti Fraud - font 50px dengan panah */}
