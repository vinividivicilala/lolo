...
// Fungsi handle toggle - PERBAIKAN
const handleReportToggle = () => {
  ...
  if (!isReportExpanded) {
    ...
    // Expand container ke kiri dan bawah
    gsap.to(container, {
    ...
    // Kembalikan report ke posisi semula
    gsap.to(report, {
      width: "auto",
      height: "48px",
    ...
    gsap.to(container, {
      ...
      onComplete: () => {
        ...
        // Pastikan teks kembali ke awal
        if (text && text.textContent !== "Read the Report") {
