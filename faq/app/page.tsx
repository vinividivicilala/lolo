...
{/* FLOATING BUTTON - Tengah Bawah dengan Expand */}
<div
  style={{
    position: 'fixed',
    bottom: '30px',
...
>
  {/* Expandable Container - Muncul ke ATAS saat expanded */}
  <div
    style={{
      position: 'absolute',
      bottom: '100%',
      left: '50%',
      transform: `translateX(-50%) translateY(${isExpanded ? '0' : '-20px'})`,
      marginBottom: '16px',
