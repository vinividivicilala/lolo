...
useEffect(() => {
  ...
  if (!report || !text || !icon || !logo) return;
...
const handleReportToggle = () => {
  ...
  if (!isReportExpanded) {
    ...
    // Kembalikan teks ke ukuran normal
    gsap.to(text, {
      fontSize: "18px",
      fontWeight: 600,
      duration: 0.3,
    ...
    // Kembalikan icon ke ukuran normal
    gsap.to(icon, {
      fontSize: "30px",
      fontWeight: 300,
      rotation: 0,
    ...
    // Kembalikan container ke ukuran normal
    gsap.to(container, {
      width: `${buttonWidth}px`,
      height: `${buttonHeight}px`,
      duration: 0.7,
