  ...
  return (
    <>
      ...
      >
        ...
        {/* ===== CHAT BOX - FULL (tanpa tombol, tanpa bg tambahan) ===== */}
        {user ? (
          // Jika user login, tampilkan chat box + teks Live Chat
          <>
            <div
              style={{
                position: "fixed",
            ...
            >
              ...
              {/* Teks Live Chat - tanpa tombol, tanpa bg tambahan */}
              <div
          ...
          // Jika tidak login, tampilkan teks "Live Chat Silakan login untuk menggunakan Live Chat"
          <div
            style={{
              position: "fixed",
              bottom: "40px",
          ...
          >
            Live Chat Silakan login untuk menggunakan Live Chat
          </div>
        )}
