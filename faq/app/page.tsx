...
export default function HomePage(): React.JSX.Element {
 ...
 // Tambahkan di bagian state refs (sekitar baris 444-447)
...
const [card4Ref, setCard4Ref] = useState<HTMLDivElement | null>(null); // BARU
const [card5Ref, setCard5Ref] = useState<HTMLDivElement | null>(null); // BARU
const [card6Ref, setCard6Ref] = useState<HTMLDivElement | null>(null); // BARU
...
useEffect(() => {
  ...
  if (cardsPinnedRef.current && card1Ref && card2Ref && card3Ref && card4Ref && card5Ref && card6Ref) {
    ...
    // Set posisi awal - jarak antar card 300px
    gsap.set(card1Ref, { y: 0, zIndex: 5 });
    gsap.set(card2Ref, { y: 300, zIndex: 6 });
    gsap.set(card3Ref, { y: 600, zIndex: 7 });
    gsap.set(card4Ref, { y: 900, zIndex: 8 });
    gsap.set(card5Ref, { y: 1200, zIndex: 9 });
    gsap.set(card6Ref, { y: 1500, zIndex: 10 });
    ...
    const tl = gsap.timeline({
      scrollTrigger: {
        trigger: section,
        start: "top top",
        end: "+=1200%", // Ditingkatkan dari 900% ke 1200%
        pin: pinWrap,
        scrub: 1.5,
        anticipatePin: 1,
    ...
    tl.to(card2Ref, { y: 0, duration: 1.2, ease: "power2.inOut" }, 0)
      .to(card3Ref, { y: 300, duration: 1.2, ease: "power2.inOut" }, 0.5)
      .to(card4Ref, { y: 600, duration: 1.2, ease: "power2.inOut" }, 1.0)
      .to(card5Ref, { y: 900, duration: 1.2, ease: "power2.inOut" }, 1.5)
      .to(card6Ref, { y: 1200, duration: 1.2, ease: "power2.inOut" }, 2.0);
...
{!isLoading && (
  <div
    ...
    style={{
      width: '100%',
      minHeight: '1100vh', // DITINGKATKAN DRAMATIS dari 900vh ke 1100vh
      position: 'relative',
      backgroundColor: '#f5f5f5',
      marginBottom: '0',
    }}
  >
    {/* JUDUL COMMUNITY 200px + PANAH SVG - TANPA GARIS BAWAH */}
    <div style={{
      position: 'sticky',
      top: '0',
      zIndex: 20,
    ...
    {/* STACKED CARDS CONTAINER - 6 CARD */}
    <div
      ref={cardsPinnedRef}
      style={{
        width: '100%',
        ...
        overflow: 'visible',
        marginTop: '80px',
        marginBottom: '200px', // Ditambah margin bottom lebih besar
      }}
    >
      <div style={{
        position: 'relative',
        ...
        <div
          ...
          style={{
            ...
            top: '50%',
            left: '50%',
            transform: 'translate(-50%, -50%) translateY(900px)',
            width: '91%',
            height: '91%',
            backgroundColor: '#ffffff',
            border: '2px solid #000000',
        ...
        <div
          ...
          style={{
            ...
            top: '50%',
            left: '50%',
            transform: 'translate(-50%, -50%) translateY(1500px)',
            width: '85%',
            height: '85%',
            backgroundColor: '#ffffff',
            border: '2px solid #000000',
