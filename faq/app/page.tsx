...
export default function HomePage(): React.JSX.Element {
    ...
    const handleForgotPassword = async () => {
        if (!forgotEmail.trim()) {
            setForgotStatus("Masukkan email Anda");
            return;
        }
        setForgotStatus("Tautan reset password akan dikirim ke email Anda");
        setTimeout(() => {
            setForgotStatus("");
    ...
    const handleContactSubmit = async () => {
        if (!contactMessage.trim()) {
            setContactStatus("Masukkan pesan Anda");
            return;
        }
        setContactStatus("Pesan terkirim! Kami akan merespon segera.");
        setTimeout(() => {
            setContactStatus("");
    ...
    // ===== GSAP NAVBAR TEXT ANIMATION =====
    useEffect(() => {
        // Animate navbar text items with GSAP hover effect (scrolling back and forth)
        const navItems = document.querySelectorAll('.navbar-text-item');
        navItems.forEach((item) => {
            const el = item as HTMLElement;
            const originalText = el.textContent || '';

            // Create a wrapper for the scrolling effect
            ...
            // Create two spans for the scrolling text
            const span1 = document.createElement('span');
            span1.textContent = originalText;
            span1.style.display = 'inline-block';
            span1.style.transition = 'transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)';
            ...
            span2.style.transition = 'transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1), opacity 0.4s ease';

            // Clone the original text node
            ...
            (el as any)._span1 = span1;
            (el as any)._span2 = span2;
        ...
        return () => {
            // Cleanup
            document.querySelectorAll('.navbar-text-item').forEach((item) => {
                const el = item as HTMLElement;
        ...
        <>
            ...
            >
                ...
                <div style={{
                    ...
                    >
                        {/* ===== NAVBAR TEXT ITEMS WITH GSAP ANIMATION ===== */}
                        {["Note", "Donations", "News", "Calendar"].map((text) => (
                            <span
                                key={text}
                                className="navbar-text-item"
                                style={{
                                    fontSize: "29px",
                                    fontWeight: 500,
                                    color: "#000000",
                    ...
                    {/* ===== KANAN: Shop + Pusat bantuan + Notif + Sign Up / Profile ===== */}
                    <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                        {/* Shop Button */}
                        <motion.button
                            initial={{ opacity: 0, y: -20 }}
                        ...
                        {!user ? (
                            <div ref={signUpDropdownRef} style={{ position: "relative" }}>
                                <motion.button
                                ...
                                <AnimatePresence>
                                    {showSignUpDropdown && (
                                        ...
                                        >
                                            ...
                                            >
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M12 11V15H18C17.7 17.4 15.3 19 12 19C8.7 19 6 16.3 6 13C6 9.7 8.7 7 12 7C13.4 7 14.7 7.5 15.7 8.3L18.7 5.3C16.8 3.6 14.5 2.5 12 2.5C6.2 2.5 1.5 7.2 1.5 13C1.5 18.8 6.2 23.5 12 23.5C17.8 23.5 22.5 18.8 22.5 13C22.5 11.8 22.3 10.8 21.9 9.9L12 11Z" fill="#4285F4" />
                                                    <path d="M3.5 8.2L6.9 10.8C7.7 9.2 9.1 8 10.9 7.6L8.8 4.1C7.1 5 5.8 6.5 4.6 8.2H3.5Z" fill="#34A853" />
                                                    <path d="M12 23.5C14.5 23.5 16.8 22.4 18.5 20.6L15.4 17.7C14.2 18.6 12.7 19 12 19C10.1 19 8.5 17.8 7.7 16.1L4.4 18.5C6.1 21.5 9.6 23.5 12 23.5Z" fill="#FBBC05" />
                                                    <path d="M20.5 13.5H12V11H21.9C22.1 11.6 22.2 12.3 22.2 13H22.5C22.5 14.5 22 16 21.2 17.3L18.1 14.4C19.1 13.6 19.8 12.7 20.5 13.5Z" fill="#EA4335" />
                                                </svg>
                                            ...
                                            >
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M12 2C8.13 2 5 5.13 5 9C5 13.17 9.35 18.34 11.18 20.2C11.63 20.67 12.37 20.67 12.82 20.2C14.65 18.34 19 13.17 19 9C19 5.13 15.87 2 12 2ZM12 11.5C10.62 11.5 9.5 10.38 9.5 9C9.5 7.62 10.62 6.5 12 6.5C13.38 6.5 14.5 7.62 14.5 9C14.5 10.38 13.38 11.5 12 11.5Z" fill="#666" />
                                                </svg>
                                            ...
                                            >
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <path d="M8 9H16" stroke="#666" strokeWidth="1.5" strokeLinecap="round" />
                                                    <path d="M8 13H12" stroke="#666" strokeWidth="1.5" strokeLinecap="round" />
                                                </svg>
                                                <span>Contact</span>
                                            </motion.button>
                                        </motion.div>
                            ...
                            /* ===== PROFILE PHOTO WITH DROPDOWN (When logged in) ===== */
                    ...
                    {showForgotPassword && (
                        ...
                        >
                            <motion.div
                                ...
                                onClick={(e) => e.stopPropagation()}
                            >
                                <h3 style={{ fontSize: "20px", fontWeight: 600, color: "#000", marginBottom: "8px", fontFamily: FONT_FAMILY }}>
                                    Lupa Password
                                </h3>
                                <p style={{ fontSize: "13px", color: "#666", marginBottom: "16px", fontFamily: FONT_FAMILY }}>
                                ...
                                />
                                {forgotStatus && (
                                    <div style={{ fontSize: "12px", color: "#0D3CFC", marginBottom: "12px", fontFamily: FONT_FAMILY }}>
                                        {forgotStatus}
                                    </div>
                                )}
                    ...
                    {showContactModal && (
                        ...
                        >
                            ...
                            >
                                ...
                                <p style={{ fontSize: "13px", color: "#666", marginBottom: "16px", fontFamily: FONT_FAMILY }}>
                                    Kirim pesan ke tim Menuru. Kami akan merespon segera.
                                </p>
                                <textarea
                                ...
                                />
                                {contactStatus && (
                                    <div style={{ fontSize: "12px", color: "#22c55e", marginBottom: "12px", fontFamily: FONT_FAMILY }}>
                                        {contactStatus}
                                    </div>
                                )}
                                <div style={{ display: "flex", gap: "8px" }}>
