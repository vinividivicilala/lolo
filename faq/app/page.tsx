...
export default function HomePage(): React.JSX.Element {
  ...
  useEffect(() => {
    ...
    if (cardsPinnedRef.current && card1Ref && card2Ref && card3Ref && card4Ref && card5Ref && card6Ref) {
      ...
      // KILL TRIGGER LAMA UNTUK MENCEGAH KONFLIK
      ...
      // RESET POSISI AWAL KARTU (PENTING!)
      // Kita hapus transform bawaan React/CSS agar GSAP punya kontrol penuh
      gsap.set([card1Ref, card2Ref, card3Ref, card4Ref, card5Ref, card6Ref], { clearProps: "all" });
      
      // Set posisi awal manual via GSAP (bukan CSS transform)
      gsap.set(card1Ref, { y: 0, zIndex: 1 });
      gsap.set(card2Ref, { y: 250, zIndex: 2 });
      gsap.set(card3Ref, { y: 500, zIndex: 3 });
      gsap.set(card4Ref, { y: 750, zIndex: 4 });
      gsap.set(card5Ref, { y: 1000, zIndex: 5 });
      gsap.set(card6Ref, { y: 1250, zIndex: 6 });

      const tl = gsap.timeline({
        scrollTrigger: {
          trigger: section,
          start: "top top",
          end: "+=3500%", // DIPERPANJANG SIGNIFIKAN agar 6 kartu punya waktu muncul
          pin: pinWrap,
          scrub: 1.5,
          anticipatePin: 1,
      ...
      // ANIMASI SEKUENSIAL
      // Setiap kartu bergerak ke posisi y:0 (tengah) secara bergantian
      tl.to(card2Ref, { y: 0, duration: 1.5, ease: "power2.inOut" }, 0)
        .to(card3Ref, { y: 250, duration: 1.5, ease: "power2.inOut" }, 0.8)
        .to(card4Ref, { y: 500, duration: 1.5, ease: "power2.inOut" }, 1.6)
        .to(card5Ref, { y: 750, duration: 1.5, ease: "power2.inOut" }, 2.4)
        .to(card6Ref, { y: 1000, duration: 1.5, ease: "power2.inOut" }, 3.2);
  ...
  <div
    ...
    style={{
      width: '100%',
      minHeight: '100vh', // Biarkan GSAP Pin yang mengatur tinggi scroll
      position: 'relative',
      backgroundColor: '#f5f5f5',
    }}
  >
    {/* JUDUL COMMUNITY STICKY (TETAP SAMA) */}
    <div style={{
      position: 'sticky',
      top: '0',
      zIndex: 20,
    ...
    >
      <div style={{
        ...
        height: '85vh',
        margin: '0 auto',
        // SPACER PENTING: Padding bawah besar agar kartu terakhir tidak nabrak section berikutnya
        paddingBottom: '60vh', 
        boxSizing: 'border-box'
      }}>
        ...
        <div
          ...
          style={{
            ...
            top: '50%',
            left: '50%',
            transform: 'translate(-50%, -50%)', // Hapus translateY dari sini
            width: '100%',
            height: '100%',
            backgroundColor: '#ffffff',
        ...
        >
          <div style={{ padding: '45px 55px 0 55px', borderBottom: '2px solid #000000' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '35px' }}>
              <div style={{ fontSize: '95px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", fontWeight: '400', letterSpacing: '-0.02em', lineHeight: '1', color: '#000000' }}>CREATIVE<br />STUDIO</div>
              <button style={{ display: 'flex', alignItems: 'center', gap: '14px', background: 'transparent', border: '1.5px solid #000000', cursor: 'pointer', fontSize: '16px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#000000', padding: '14px 28px', marginBottom: '12px', transition: 'all 0.2s ease' }} onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#000000'; e.currentTarget.style.color = '#ffffff'; }} onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = 'transparent'; e.currentTarget.style.color = '#000000'; }}><span>VIEW ONLINE</span><NorthEastArrowIcon size={18} /></button>
            </div>
          </div>
          <div style={{ padding: '55px 55px 45px 55px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <p style={{ fontFamily: "'Questrial', sans-serif", fontSize: '18px', lineHeight: '1.6', color: '#333333', marginBottom: '35px', maxWidth: '70%' }}>Award-winning UX/UI design studio crafting digital experiences that blend creativity with functionality. Based in Jakarta, serving global clients since 2020.</p>
              <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}><span style={{ padding: '6px 22px', background: '#f0f0f0', fontSize: '13px', fontFamily: "'Questrial', sans-serif" }}>UX Research</span><span style={{ padding: '6px 22px', background: '#f0f0f0', fontSize: '13px', fontFamily: "'Questrial', sans-serif" }}>UI Design</span><span style={{ padding: '6px 22px', background: '#f0f0f0', fontSize: '13px', fontFamily: "'Questrial', sans-serif" }}>Prototyping</span><span style={{ padding: '6px 22px', background: '#f0f0f0', fontSize: '13px', fontFamily: "'Questrial', sans-serif" }}>Design System</span></div>
            </div>
            <div style={{ marginTop: '45px', paddingTop: '25px', borderTop: '1px solid #e0e0e0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ fontSize: '14px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#999999' }}>MENURU STUDIO — Since 2020</span><span style={{ fontSize: '14px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#999999' }}>01 / 06</span></div>
          </div>
        </div>
        ...
        >
          <div style={{ padding: '42px 52px 0 52px', borderBottom: '2px solid #000000' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '32px' }}>
              <div style={{ fontSize: '88px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", fontWeight: '400', letterSpacing: '-0.02em', lineHeight: '1', color: '#000000' }}>AI CREATIVE<br />LAB</div>
              <button style={{ display: 'flex', alignItems: 'center', gap: '13px', background: 'transparent', border: '1.5px solid #000000', cursor: 'pointer', fontSize: '15px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#000000', padding: '13px 26px', marginBottom: '11px', transition: 'all 0.2s ease' }} onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#000000'; e.currentTarget.style.color = '#ffffff'; }} onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = 'transparent'; e.currentTarget.style.color = '#000000'; }}><span>VIEW ONLINE</span><NorthEastArrowIcon size={17} /></button>
            </div>
          </div>
          <div style={{ padding: '50px 52px 42px 52px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <p style={{ fontFamily: "'Questrial', sans-serif", fontSize: '17px', lineHeight: '1.6', color: '#333333', marginBottom: '30px', maxWidth: '68%' }}>Harnessing artificial intelligence to revolutionize creative workflows, from generative design to intelligent automation and predictive analytics.</p>
              <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}><span style={{ padding: '5px 20px', background: '#f0f0f0', fontSize: '12px', fontFamily: "'Questrial', sans-serif" }}>Machine Learning</span><span style={{ padding: '5px 20px', background: '#f0f0f0', fontSize: '12px', fontFamily: "'Questrial', sans-serif" }}>Generative AI</span><span style={{ padding: '5px 20px', background: '#f0f0f0', fontSize: '12px', fontFamily: "'Questrial', sans-serif" }}>Computer Vision</span><span style={{ padding: '5px 20px', background: '#f0f0f0', fontSize: '12px', fontFamily: "'Questrial', sans-serif" }}>NLP</span></div>
            </div>
            <div style={{ marginTop: '40px', paddingTop: '23px', borderTop: '1px solid #e0e0e0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ fontSize: '13px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#999999' }}>AI INNOVATION DIVISION</span><span style={{ fontSize: '13px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#999999' }}>02 / 06</span></div>
          </div>
        </div>
        ...
        >
          <div style={{ padding: '38px 48px 0 48px', borderBottom: '2px solid #000000' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '28px' }}>
              <div style={{ fontSize: '80px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", fontWeight: '400', letterSpacing: '-0.02em', lineHeight: '1', color: '#000000' }}>DESIGN<br />NETWORK</div>
              <button style={{ display: 'flex', alignItems: 'center', gap: '12px', background: 'transparent', border: '1.5px solid #000000', cursor: 'pointer', fontSize: '14px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#000000', padding: '12px 24px', marginBottom: '10px', transition: 'all 0.2s ease' }} onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#000000'; e.currentTarget.style.color = '#ffffff'; }} onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = 'transparent'; e.currentTarget.style.color = '#000000'; }}><span>VIEW ONLINE</span><NorthEastArrowIcon size={16} /></button>
            </div>
          </div>
          <div style={{ padding: '45px 48px 38px 48px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <p style={{ fontFamily: "'Questrial', sans-serif", fontSize: '16px', lineHeight: '1.6', color: '#333333', marginBottom: '28px', maxWidth: '65%' }}>Join thousands of creative professionals sharing insights, opportunities, and inspiration in Southeast Asia's fastest growing design community.</p>
              <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}><span style={{ padding: '5px 18px', background: '#f0f0f0', fontSize: '12px', fontFamily: "'Questrial', sans-serif" }}>10k+ Members</span><span style={{ padding: '5px 18px', background: '#f0f0f0', fontSize: '12px', fontFamily: "'Questrial', sans-serif" }}>Weekly Events</span><span style={{ padding: '5px 18px', background: '#f0f0f0', fontSize: '12px', fontFamily: "'Questrial', sans-serif" }}>Mentorship</span><span style={{ padding: '5px 18px', background: '#f0f0f0', fontSize: '12px', fontFamily: "'Questrial', sans-serif" }}>Job Board</span></div>
            </div>
            <div style={{ marginTop: '35px', paddingTop: '22px', borderTop: '1px solid #e0e0e0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ fontSize: '13px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#999999' }}>GLOBAL COMMUNITY HUB</span><span style={{ fontSize: '13px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#999999' }}>03 / 06</span></div>
          </div>
        </div>
        ...
        >
          <div style={{ padding: '35px 45px 0 45px', borderBottom: '2px solid #000000' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '25px' }}>
              <div style={{ fontSize: '75px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", fontWeight: '400', letterSpacing: '-0.02em', lineHeight: '1', color: '#000000' }}>DIGITAL<br />INNOVATION</div>
              <button style={{ display: 'flex', alignItems: 'center', gap: '11px', background: 'transparent', border: '1.5px solid #000000', cursor: 'pointer', fontSize: '14px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#000000', padding: '11px 22px', marginBottom: '9px', transition: 'all 0.2s ease' }} onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#000000'; e.currentTarget.style.color = '#ffffff'; }} onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = 'transparent'; e.currentTarget.style.color = '#000000'; }}><span>VIEW ONLINE</span><NorthEastArrowIcon size={15} /></button>
            </div>
          </div>
          <div style={{ padding: '42px 45px 35px 45px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <p style={{ fontFamily: "'Questrial', sans-serif", fontSize: '16px', lineHeight: '1.6', color: '#333333', marginBottom: '25px', maxWidth: '65%' }}>Driving digital transformation through cutting-edge technology, helping businesses adapt and thrive in the rapidly evolving digital landscape.</p>
              <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}><span style={{ padding: '5px 18px', background: '#f0f0f0', fontSize: '12px', fontFamily: "'Questrial', sans-serif" }}>Digital Strategy</span><span style={{ padding: '5px 18px', background: '#f0f0f0', fontSize: '12px', fontFamily: "'Questrial', sans-serif" }}>Cloud Computing</span><span style={{ padding: '5px 18px', background: '#f0f0f0', fontSize: '12px', fontFamily: "'Questrial', sans-serif" }}>IoT Solutions</span><span style={{ padding: '5px 18px', background: '#f0f0f0', fontSize: '12px', fontFamily: "'Questrial', sans-serif" }}>Blockchain</span></div>
            </div>
            <div style={{ marginTop: '32px', paddingTop: '20px', borderTop: '1px solid #e0e0e0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ fontSize: '13px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#999999' }}>TECH INNOVATION LAB</span><span style={{ fontSize: '13px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#999999' }}>04 / 06</span></div>
          </div>
        </div>
        ...
        >
          <div style={{ padding: '32px 42px 0 42px', borderBottom: '2px solid #000000' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '22px' }}>
              <div style={{ fontSize: '70px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", fontWeight: '400', letterSpacing: '-0.02em', lineHeight: '1', color: '#000000' }}>CREATIVE<br />WORKSHOP</div>
              <button style={{ display: 'flex', alignItems: 'center', gap: '10px', background: 'transparent', border: '1.5px solid #000000', cursor: 'pointer', fontSize: '13px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#000000', padding: '10px 20px', marginBottom: '8px', transition: 'all 0.2s ease' }} onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#000000'; e.currentTarget.style.color = '#ffffff'; }} onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = 'transparent'; e.currentTarget.style.color = '#000000'; }}><span>VIEW ONLINE</span><NorthEastArrowIcon size={14} /></button>
            </div>
          </div>
          <div style={{ padding: '38px 42px 32px 42px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <p style={{ fontFamily: "'Questrial', sans-serif", fontSize: '15px', lineHeight: '1.6', color: '#333333', marginBottom: '22px', maxWidth: '65%' }}>Hands-on creative workshops and bootcamps designed to unlock your team's potential, fostering innovation and collaborative problem-solving.</p>
              <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}><span style={{ padding: '4px 16px', background: '#f0f0f0', fontSize: '11px', fontFamily: "'Questrial', sans-serif" }}>Workshops</span><span style={{ padding: '4px 16px', background: '#f0f0f0', fontSize: '11px', fontFamily: "'Questrial', sans-serif" }}>Bootcamps</span><span style={{ padding: '4px 16px', background: '#f0f0f0', fontSize: '11px', fontFamily: "'Questrial', sans-serif" }}>Team Building</span><span style={{ padding: '4px 16px', background: '#f0f0f0', fontSize: '11px', fontFamily: "'Questrial', sans-serif" }}>Skill Training</span></div>
            </div>
            <div style={{ marginTop: '28px', paddingTop: '18px', borderTop: '1px solid #e0e0e0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ fontSize: '12px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#999999' }}>CREATIVE LEARNING HUB</span><span style={{ fontSize: '12px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#999999' }}>05 / 06</span></div>
          </div>
        </div>
        ...
        >
          <div style={{ padding: '28px 38px 0 38px', borderBottom: '2px solid #000000' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '20px' }}>
              <div style={{ fontSize: '65px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", fontWeight: '400', letterSpacing: '-0.02em', lineHeight: '1', color: '#000000' }}>DESIGN<br />LEADERSHIP</div>
              <button style={{ display: 'flex', alignItems: 'center', gap: '10px', background: 'transparent', border: '1.5px solid #000000', cursor: 'pointer', fontSize: '13px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#000000', padding: '9px 18px', marginBottom: '7px', transition: 'all 0.2s ease' }} onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#000000'; e.currentTarget.style.color = '#ffffff'; }} onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = 'transparent'; e.currentTarget.style.color = '#000000'; }}><span>VIEW ONLINE</span><NorthEastArrowIcon size={13} /></button>
            </div>
          </div>
          <div style={{ padding: '35px 38px 28px 38px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <p style={{ fontFamily: "'Questrial', sans-serif", fontSize: '15px', lineHeight: '1.6', color: '#333333', marginBottom: '22px', maxWidth: '65%' }}>Empowering design leaders to drive organizational change, build high-performing teams, and create lasting impact through strategic design thinking.</p>
              <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}><span style={{ padding: '4px 16px', background: '#f0f0f0', fontSize: '11px', fontFamily: "'Questrial', sans-serif" }}>Leadership Training</span><span style={{ padding: '4px 16px', background: '#f0f0f0', fontSize: '11px', fontFamily: "'Questrial', sans-serif" }}>Strategy</span><span style={{ padding: '4px 16px', background: '#f0f0f0', fontSize: '11px', fontFamily: "'Questrial', sans-serif" }}>Mentorship</span><span style={{ padding: '4px 16px', background: '#f0f0f0', fontSize: '11px', fontFamily: "'Questrial', sans-serif" }}>Career Growth</span></div>
            </div>
            <div style={{ marginTop: '25px', paddingTop: '16px', borderTop: '1px solid #e0e0e0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ fontSize: '12px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#999999' }}>LEADERSHIP ACADEMY</span><span style={{ fontSize: '12px', fontFamily: "'Aeonik-Regular', Helvetica, Arial, sans-serif", color: '#999999' }}>06 / 06</span></div>
          </div>
        </div>
