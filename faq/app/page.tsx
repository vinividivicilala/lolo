...
useEffect(() => {
  ...
  if (cardsPinnedRef.current && card1Ref && card2Ref && card3Ref && card4Ref && card5Ref && card6Ref) {
    ...
    // Set posisi awal - jarak antar card 350px
    gsap.set(card1Ref, { y: 0, zIndex: 5 });
    gsap.set(card2Ref, { y: 350, zIndex: 6 });
    gsap.set(card3Ref, { y: 700, zIndex: 7 });
    gsap.set(card4Ref, { y: 1050, zIndex: 8 });
    gsap.set(card5Ref, { y: 1400, zIndex: 9 });
    gsap.set(card6Ref, { y: 1750, zIndex: 10 });
    ...
    const tl = gsap.timeline({
      scrollTrigger: {
        trigger: section,
        start: "top top",
        end: "+=2000%", // DITINGKATKAN DARI 1500% KE 2000%
        pin: pinWrap,
        scrub: 1.5,
        anticipatePin: 1,
    ...
    tl.to(card2Ref, { y: 0, duration: 1.5, ease: "power2.inOut" }, 0)
      .to(card3Ref, { y: 350, duration: 1.5, ease: "power2.inOut" }, 0.8)
      .to(card4Ref, { y: 700, duration: 1.5, ease: "power2.inOut" }, 1.6)
      .to(card5Ref, { y: 1050, duration: 1.5, ease: "power2.inOut" }, 2.4)
      .to(card6Ref, { y: 1400, duration: 1.5, ease: "power2.inOut" }, 3.2);
...
{!isLoading && (
  <div
    ...
    style={{
      width: '100%',
      minHeight: '1500vh', // DITINGKATKAN LEBIH BESAR
      position: 'relative',
  ...
  >
    ...
    {/* STACKED CARDS CONTAINER - 6 CARD DENGAN JARAK YANG LEBIH BESAR */}
    <div
      ref={cardsPinnedRef}
      style={{
        width: '100%',
        ...
        justifyContent: 'center',
        overflow: 'visible',
        marginTop: '150px', // DITINGKATKAN DARI 80px KE 150px
        marginBottom: '300px', // DITINGKATKAN DARI 200px KE 300px
      }}
    >
      <div style={{
        position: 'relative',
        ...
        <div
          ...
          style={{
            ...
            top: '50%',
            left: '50%',
            transform: 'translate(-50%, -50%) translateY(350px)', // DARI 250px KE 350px
            width: '97%',
            height: '97%',
            backgroundColor: '#ffffff',
            border: '2px solid #000000',
        ...
        <div
          ...
          style={{
            ...
            top: '50%',
            left: '50%',
            transform: 'translate(-50%, -50%) translateY(700px)', // DARI 500px KE 700px
            width: '94%',
            height: '94%',
            backgroundColor: '#ffffff',
            border: '2px solid #000000',
        ...
        <div
          ...
          style={{
            ...
            top: '50%',
            left: '50%',
            transform: 'translate(-50%, -50%) translateY(1050px)', // DARI 750px KE 1050px
            width: '91%',
            height: '91%',
            backgroundColor: '#ffffff',
            border: '2px solid #000000',
        ...
        <div
          ...
          style={{
            ...
            top: '50%',
            left: '50%',
            transform: 'translate(-50%, -50%) translateY(1400px)', // DARI 1000px KE 1400px
            width: '88%',
            height: '88%',
            backgroundColor: '#ffffff',
            border: '2px solid #000000',
        ...
        <div
          ...
          style={{
            ...
            top: '50%',
            left: '50%',
            transform: 'translate(-50%, -50%) translateY(1750px)', // DARI 1250px KE 1750px
            width: '85%',
            height: '85%',
            backgroundColor: '#ffffff',
            border: '2px solid #000000',
