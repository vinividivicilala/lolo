      ...
      >
        ...
        >
          ...
          >
            ...
            // Tambahkan di bagian setelah div foto portrait (di dalam Main Sign In Container)
{!isMobile && (
  <div
    style={{
      width: '500px',
      ...
      borderRadius: '20px',
      boxShadow: '0 10px 30px rgba(0,0,0,0.3)',
      position: 'relative', // Ditambahkan untuk positioning
    }}
  >
